...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231014142402_AddTaskStatusTransition")]
    partial class AddTaskStatusTransition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Tasks.TaskStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Tasks.TaskStatusTransition", b =>
                {
            ...
            modelBuilder.Entity("Domain.Tasks.Workflow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Tasks.Task", b =>
                {
                    ...
                    b.HasOne("Domain.Tasks.TaskStatus", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Tasks.TaskStatus", b =>
                {
                    b.HasOne("Domain.Tasks.Workflow", null)
                        .WithMany("Statuses")
            ...
            modelBuilder.Entity("Domain.Tasks.Workflow", b =>
                {
                    b.HasOne("Domain.Projects.Project", null)
                        .WithOne()
                        .HasForeignKey("Domain.Tasks.Workflow", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
