...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250621113436_RenamedTaskRelationshipToRelation")]
    partial class RenamedTaskRelationshipToRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Projects.MemberRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Tasks.TaskAttachment", b =>
                {
                    b.Property<int>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Tasks.TaskHierarchicalRelation", b =>
                {
                    ...
                    b.Property<Guid?>("TaskRelationManagerId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TaskRelationManagerId");

                    b.ToTable("TaskHierarchicalRelations");
                });

            modelBuilder.Entity("Domain.Tasks.TaskRelationManager", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TaskRelationManagers");
                });
            ...
            modelBuilder.Entity("Domain.Tasks.TaskHierarchicalRelation", b =>
                {
                    ...
                    b.HasOne("Domain.Tasks.TaskRelationManager", null)
                        .WithMany("HierarchicalRelations")
                        .HasForeignKey("TaskRelationManagerId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Domain.Tasks.TaskRelationManager", b =>
                {
                    b.Navigation("HierarchicalRelations");
                });
