...
public record TaskRelationsVM(TaskRelationsParentVM? Parent, TaskHierarchyVM? ChildrenHierarchy);
public record TaskRelationsParentVM(Guid Id, string Title, int ShortId);
